...
const dataPhP: LeaderboardStructure[] = [
  {
    ...
    image:
      "https://i.pinimg.com/236x/36/b9/9d/36b99dd44debc8614db0c7445ac57b3b.jpg",
    stats: {
      wins: 15,
      points: 2450,
      winRate: 88,
...
const ordenamiento_players = dataPhP.sort(
...
const LeaderboardThing = ({
  item,
  index,
}: {
  item: LeaderboardStructure;
  index: number;
}) => {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <LeaderboardThing item={item} index={index} />
        )}
